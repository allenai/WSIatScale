...
def main():
    ...
    n_reps = st.sidebar.slider(f"Number of replacements (Taken from {args.model_hg_path}'s masked LM)", 1, 100, 20)
    args.n_reps = n_reps
    ...
    for w in word.split(';'):
        ...
        if token:
            ...
            curr_word_rep_instances.remove_certain_words(remove_query_word=True,
